...
const Nav = () => {
  return (
    <nav className="flex justify-between px-32 pt-10 items-center">
      {/* <Link to="/"> */}
      ...
      <ul className="flex space-x-7 items-center justify-center">
        ...
        <li> 
          <a href="#contact">
            <button className="border-[#5c1be0] border-2 rounded-full px-6 py-2 text-lg text-[#5c1be0]"> Say Hello </button>
          </a>
        </li>
      </ul>
    </nav>
  ...
  return (
    <div>
      ...
      <section className="flex justify-center items-center">
        <div className="flex flex-col justify-center w-2/3 items-center  pt-28">
          <div className="flex flex-col items-center justify-center" >
            <h1 className="text-5xl font-bold text-center font-quicksand">Hey, I am Prince, A Full Stack Developer </h1>
            <p className="text-2xl mt-5 font-quicksand"> I code beautifully simple things, and I love what I do. </p>
          ...
          <div className="flex flex-col justify-center items-center  pt-14 space-y-14">
            ...
            <img src={DeviceImage} className="w-2/3" alt="Devices" />
          </div>
        </div>
      </section>
...
const SkillCard = () => {
  return (
    <div className="flex flex-col items-center justify-center text-center">
      <div className="flex justify-center items-stretch mt-[-130px]  border rounded-lg bg-white w-3/4">
        {/* frontend skill */}
        <div className="flex flex-col items-center justify-start py-12 w-1/3 px-8 border-r">
        ...
        {/* DSA and CP skill */}
        <div className="flex flex-col items-center justify-start py-12 w-1/3 px-8">
          <div className="bg-[#84e6bc] p-6 rounded-full">
  ...
  return (
    <>
      <div className="bg-[#5c1be0] flex justify-center">
        <div className="flex flex-col justify-center items-center w-2/3 pt-32 pb-60">
          <h1 className="text-4xl text-white font-bold text-center mb-2 font-mono">Hi, I'm Prince Mishra. Nice to meet you.</h1>
          <p className="text-white text-xl p-3 text-center font-quicksand font-semibold">
...
const ProjectsCards = () => {
  return (
    <div className="flex flex-col items-center justify-center text-center mt-[-130px]">
      <div className="grid grid-cols-2 w-4/5 bg-white m-auto rounded-lg p-16 gap-4 border-2 mb-16">
  ...
  return (
    <div id="projects">
      <div className="bg-[#5c1be0] flex justify-center mt-16">
        <div className="flex flex-col justify-center items-center w-1/2 pt-32 pb-60">
          <h1 className="text-4xl text-white font-bold text-center mb-2 font-mono">Projects I have Worked on</h1>
        </div>
      </div>
      <ProjectsCards />
    </div>
    ...
    <>
      <div id="contact" className="bg-[#5c1be0] text-white">
        <div className="flex flex-col justify-center items-center p-16 text-center">
          <h1 className="text-3xl font-bold">Interested in collaborating with me?</h1>
          <p className="text-lg ">I'm always open to discussing product design work or partnership opportunities</p>
        </div>
      </div>
      <div className="flex flex-col justify-center items-center p-24  text-center">
        <form className="flex flex-col justify-center w-1/2 items-stretch">
...
const Footer = () => {
    return (
      <div className="bg-[#5c1be0] text-white flex flex-col justify-center items-center py-8">
        ...
        <div className="flex space-x-4 font-mono py-4">
