  ...
  return (
    <div>
      ...
      <section className="flex justify-center items-center">
        <div className="flex flex-col justify-center w-2/3 items-center  pt-32">
          <div className="flex flex-col items-center justify-center" >
            <h1 className="text-5xl font-bold">Hey, I am Prince, A Full Stack Developer </h1>
            <p className="text-2xl mt-5"> I code beautifully simple things, and I love what I do. </p>
...
const SkillCard = () => {
  return (
    <div className="flex flex-col items-center justify-center text-center">
      <div className="flex items-center justify-center space-y-5 mt-[-130px]  border rounded-lg bg-white w-3/4">
        {/* frontend skill */}
        <div className="flex flex-col items-center justify-start pt-12 w-1/3 py-4 px-8 border-r h-full">
        ...
        {/* DSA and CP skill */}
        <div className="flex flex-col items-center justify-start pt-12 w-1/3 py-4 px-8 h-full">
          <div className="bg-[#84e6bc] p-6 rounded-full">
    ...
    <>
      <div className="bg-[#5c1be0] flex justify-center">
        <div className="flex flex-col justify-center items-center w-1/2 pt-32 pb-60">
          <h1 className="text-3xl text-white font-bold text-center mb-2">Hi, I'm Prince Mishra. Nice to meet you.</h1>
          <p className="text-white p-2 text-center">
            ...
            Hi I am making websites since 2019. I have worked on many projects and have learned a lot. I am a full stack developer and I love to code. I am a self taught developer and I have learned a lot from the internet. I have worked on many projects and have learned a lot. I am a full stack developer and I love to code.
          </p>
        </div>
      </div>
      <SkillCard />
